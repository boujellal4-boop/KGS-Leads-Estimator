...
conv_percent = st.slider(
    'Conversion Rate (%)', min_value=0, max_value=100, value=30, step=1,
    help='Expected percentage of leads that convert to deals.'
)
...
# Base values: high-end addressable set higher for large/complex projects; mid-end addressable keeps previous base
tech_base_values = {
